...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-900 dark:to-gray-800">
            <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-8 sm:pb-12 lg:pb-16">
                {/* Social Verification Section */}
                <CampModal />
                <div className="mb-4 sm:mb-6">
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-4 shadow-sm border border-gray-100 dark:border-gray-700">
                        <h2 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 sm:mb-3 flex items-center">
                            <svg className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-purple-600 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="bg-gradient-to-r from-purple-700/5 to-purple-400/5 dark:from-purple-600/10 dark:to-purple-400/10 rounded-lg p-2 sm:p-3 border border-purple-600/10 dark:border-purple-500/20">
                            {socialsLoading ? (
                                <div className="flex items-center justify-center py-2">
                                    <div className="animate-spin rounded-full h-3 w-3 sm:h-4 sm:w-4 border-b-2 border-purple-600 dark:border-purple-400"></div>
                                    <span className="ml-2 text-gray-600 dark:text-gray-300 text-xs sm:text-sm">Checking linked socials...</span>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                    <div className="flex items-center space-x-2">
                                        <FaXTwitter className="text-purple-600 dark:text-purple-400 w-3 h-3 sm:w-4 sm:h-4" />
                                        <span className="text-xs sm:text-sm font-medium dark:text-gray-300">
                                            Twitter: {socials?.twitter ? "✅ Linked" : "❌ Not linked"}
                                        </span>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <FaDiscord className="text-indigo-500 dark:text-indigo-400 w-3 h-3 sm:w-4 sm:h-4" />
                                        <span className="text-xs sm:text-sm font-medium dark:text-gray-300">
                                            Discord: {socials?.discord ? "✅ Linked" : "❌ Not linked"}
                                        </span>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <FaSpotify className="text-purple-600 dark:text-purple-400 w-3 h-3 sm:w-4 sm:h-4" />
                                        <span className="text-xs sm:text-sm font-medium dark:text-gray-300">
                ...
                <div className="flex flex-col gap-4 mb-6 sm:mb-8 md:mb-10">
                    ...
                    <div className="flex flex-col gap-3">
                        <button
                            className="w-full px-4 py-3 sm:px-6 sm:py-4 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-400 text-white font-bold text-base sm:text-lg rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                        ...
                        >
                            <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-2 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mb-8 sm:mb-12">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100">My Campaigns</h2>
                        {isRefreshing && (
                            <div className="flex items-center space-x-2 text-xs sm:text-sm text-purple-600 dark:text-purple-400">
                                <div className="animate-spin rounded-full h-3 w-3 sm:h-4 sm:w-4 border-b-2 border-purple-600 dark:border-purple-400"></div>
                        ...
                        {!isLoadingMyCampaigns ? (
                            myCampaigns && myCampaigns.length > 0 ? (
                                ...
                                <div className="col-span-full text-center py-8 sm:py-12">
                                    ...
                                    <p className="text-lg sm:text-xl text-gray-500 dark:text-gray-400 font-medium">No campaigns yet</p>
                                    <p className="text-sm sm:text-base text-gray-400 dark:text-gray-500 mt-1 sm:mt-2">Create your first creative project to get started</p>
                                </div>
                            )
                        ) : (
                            <div className="col-span-full text-center py-8 sm:py-12">
                                <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-purple-600 dark:border-purple-400 mx-auto"></div>
                                <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mt-3 sm:mt-4">Loading campaigns...</p>
                            </div>
                        )}
                    </div>
                </div>
    ...
    return (
        <div className="mb-12">
            <div className="bg-gradient-to-r from-purple-700/10 via-purple-600/10 to-purple-400/10 dark:from-purple-700/20 dark:via-purple-600/20 dark:to-purple-400/20 rounded-xl p-6 border border-purple-200 dark:border-purple-700">
                ...
                <p className="text-white/90 mb-6">
                    Your collection includes campaign images from campaigns you&apos;ve supported and funding receipt NFTs. All NFTs are now stored in the database for persistent access.
                </p>
                
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    {mintedNFTs.map((nft, idx) => (
                        <div key={idx} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 border border-purple-100 dark:border-purple-600">
                            <div className="relative">
                                <Image 
                                    src={nft.imageUrl} 
                                    ...
                                    width={120}
                                    height={120}
                                    className="w-full h-28 object-cover rounded-lg border border-purple-200 dark:border-purple-500"
                                />
                                <div className="absolute -top-2 -right-2 bg-gradient-to-r from-purple-700 to-purple-400 text-white text-xs px-2 py-1 rounded-full font-bold shadow-lg">
                            ...
                            <div className="mt-3">
                                ...
                                <span className="text-xs text-purple-700 dark:text-purple-200 font-medium">
                                    {nft.type === 'funding_receipt' ? 'Funding Receipt' : 
                                     nft.type === 'supported_campaign' ? 'Supported Campaign' :
                                     nft.type === 'supported_campaign_legacy' ? 'Supported Campaign (Legacy)' :
                                     'Campaign NFT'}
                                </span>
                                <a
                                    href={`/campaign/${nft.campaignAddress}`}
                                    className="text-xs text-purple-700 hover:text-purple-900 dark:text-purple-200 dark:hover:text-purple-100 font-semibold mt-1 inline-block hover:underline"
                                >
                                    View Campaign →
                                </a>
                            </div>
                ...
                <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg border border-purple-200 dark:border-purple-700">
                    <p className="text-sm text-purple-800 dark:text-purple-200 font-medium">
                        💡 <strong>Pro Tip:</strong> This collection shows campaign images from campaigns you&apos;ve supported, plus automatic funding receipt NFTs. All serve as permanent proof of your participation on the blockchain!
                    </p>
                </div>
            </div>
        </div>
...
const CampaignDonorsSection = ({ campaigns }: { campaigns: any[] | undefined }) => {
    ...
    return (
        <div className="mt-12 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Campaign Supporters</h3>
            ...
            <div className="mb-6">
                ...
                <select
                    ...
                    className="w-full md:w-1/2 px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-800 dark:text-gray-100">${(parseInt(totalFunded) / 1e6).toFixed(2)} USDT</p>
                                <p className="text-xs text-gray-500 dark:text-gray-500">From blockchain</p>
                            </div>
                        </div>
                        <div className="text-center">
                            <p className="text-sm text-gray-600 dark:text-gray-400">Total Supporters</p>
                            <p className="text-xl font-bold text-purple-600 dark:text-purple-400">{campaignDonors.length}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-500">Combined data</p>
                        </div>
                        <div className="text-right">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-500">With precise timestamps</p>
                        </div>
                    </div>
                </div>
            )}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
                                >
                            ...
                            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-900 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                                    <div className="grid grid-cols-12 gap-4 text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                        ...
                                        <div key={index} className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                            <div className="grid grid-cols-12 gap-4 items-center">
                                                ...
                                                <div className="col-span-2">
                                                    <p className="text-sm font-semibold text-green-600 dark:text-green-400">{donor.amount}</p>
                                                ...
                                                <div className="col-span-2">
                                                    <div className="flex flex-col gap-1">
                                                        {donor.source === 'database' && (
                                                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300">
                                                                ✓ Tracked
                                                            </span>
                                                        )}
                                                        {donor.hasNFT && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-3 shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <h3 className="text-xs font-semibold text-gray-800 dark:text-gray-200">Total Projects</h3>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#f45a06]/10 dark:bg-[#ff8c42]/20 rounded-full flex items-center justify-center">
                        <svg className="w-2 h-2 sm:w-3 sm:h-3 text-[#f45a06] dark:text-[#ff8c42]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Creative projects created</p>
            </div>

            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-3 shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <h3 className="text-xs font-semibold text-gray-800 dark:text-gray-200">Active Projects</h3>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Still raising funds</p>
            </div>

            <div className="bg-white dark:bg-gray-800 rounded-lg p-2 sm:p-3 shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <h3 className="text-xs font-semibold text-gray-800 dark:text-gray-200">Funded Projects</h3>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
