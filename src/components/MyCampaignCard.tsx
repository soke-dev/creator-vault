            ...
            {campaignImage && (
                <div className="relative overflow-hidden">
                    {!imageError ? (
                        ...
                        <div className="w-full h-28 sm:h-32 lg:h-36 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 dark:from-gray-700 dark:via-gray-600 dark:to-gray-500 flex items-center justify-center">
                            <div className="text-center">
                                <div className="text-xl sm:text-2xl mb-1">🚀</div>
                                <div className="text-gray-600 dark:text-gray-300 text-xs">Image Error</div>
                            </div>
                        </div>
                    )}
                    {/* Status Badge */}
